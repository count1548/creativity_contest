...
export default function TransferList({dataString, chData, allData, title}) {
    const classes = useStyles();
    const [checked, setChecked] = React.useState<number[]>([]);
    
    const rightData = allData.filter(value => !chData.includes(value))

    const [left, setLeft] = React.useState<number[]>(chData);
    const [right, setRight] = React.useState<number[]>(rightData);
                    ...
                    items.map((value : number) => {
                        ...
                        return (
                            <ListItem
                                ...
                                <ListItemText id={labelId} primary={`${dataString[value]}`}/>
                            </ListItem>
                        );
                    })
                }
